...
int main(int argc, char *argv[])
{
    ...
    cv::namedWindow("rawArmorsImage", cv::WINDOW_NORMAL);
    cv::resizeWindow("rawArmorsImage", 800, 600);
    ...
    while (true)
    {
        ...
        // 创建粗装甲板图像
        cv::Mat rawArmorsImage;
        ClassicalArmorRecognizer::CreateCommonArmorsImage(rawArmors,
                                                          cameraData.Image,
                                                          &rawArmorsImage);
        ...
        cv::imshow("rawArmorsImage", rawArmorsImage);
