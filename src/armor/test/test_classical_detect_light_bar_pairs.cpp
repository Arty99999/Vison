...
int main(int argc, char *argv[])
{
    ...
    cv::namedWindow("lightBarPairsImage", cv::WINDOW_NORMAL);
    cv::resizeWindow("lightBarPairsImage", 800, 600);
    ...
    while (true)
    {
        ...
        ClassicalArmorRecognizer::CreateLightBarPairsImage(lightBarPairs,
                                                           cameraData.Image,
                                                           &lightBarPairsImage);
        ...
        cv::imshow("lightBarPairsImage", lightBarPairsImage);
