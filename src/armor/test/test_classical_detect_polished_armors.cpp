//
// Created by plutoli on 2021/9/5.
//
...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        // 计算装甲板检测的准确率
        float armorAccuracy = static_cast<float>(armorIndex) / static_cast<float>(frameIndex);

        // 输出处理结果
        std::cout << "**************************************************" << std::endl;
        std::cout << "frame index: " << frameIndex << std::endl;
        std::cout << "armor index: " << armorIndex << std::endl;
        std::cout << "armor accuracy: " << armorAccuracy << std::endl;
        ...
        cv::imshow("polishedArmorsImage", polishedArmorsImage);
