...
int main(int argc, char *argv[])
{
    ...
    cv::namedWindow("rawLightBarsImage", cv::WINDOW_NORMAL);
    cv::resizeWindow("rawLightBarsImage", 800, 600);
    ...
    while (true)
    {
        ...
        // 创建粗灯条图像
        cv::Mat rawLightBarsImage;
        ClassicalArmorRecognizer::CreateLightBarsImage(rawLightBars,
                                                       cameraData.Image,
                                                       &rawLightBarsImage);
        ...
        cv::imshow("rawLightBarsImage", rawLightBarsImage);
